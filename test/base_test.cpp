...
TEST(base_test, style_test) {
  // supported
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style::reset), "\033[m");
  ...
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_extra::disable_underline),
            "\033[24m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_extra::dissable_strike),
            "\033[29m");
  ...
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_extra::underline_double),
            "\033[21m");
  // unsupported
  ...
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::font_default),
            "\033[10m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::blink_rapid),
            "\033[6m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::blink_slow),
            "\033[5m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::disable_blinking),
            "\033[25m");
  EXPECT_EQ(
      Foxterm::get_style(Foxterm::Style_unsupported::disable_framed_encircled),
      "\033[54m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::disable_overline),
            "\033[55m");
  EXPECT_EQ(Foxterm::get_style(
                Foxterm::Style_unsupported::disable_proportional_spacing),
            "\033[50m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::encircled),
            "\033[52m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::font_fracture),
            "\033[20m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::framed), "\033[51m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::overlined),
            "\033[53m");
  EXPECT_EQ(
      Foxterm::get_style(Foxterm::Style_unsupported::proportional_spacing),
      "\033[26m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::ideogram_underline),
            "\033[60m");
  EXPECT_EQ(
      Foxterm::get_style(Foxterm::Style_unsupported::ideogram_underline_double),
      "\033[61m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::ideogram_overline),
            "\033[62m");
  EXPECT_EQ(
      Foxterm::get_style(Foxterm::Style_unsupported::ideogram_double_overline),
      "\033[63m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::ideogram_stress),
            "\033[64m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::disable_ideogram),
            "\033[65m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::superscript),
            "\033[73m");
  EXPECT_EQ(Foxterm::get_style(Foxterm::Style_unsupported::subscript),
            "\033[74m");
  EXPECT_EQ(
      Foxterm::get_style(Foxterm::Style_unsupported::disable_super_subscript),
      "\033[75m");
}
...
TEST(base_test, 4bit_color_test) {
  ...
  EXPECT_EQ(Foxterm::get_color4(Foxterm::Color4_fg::magenta_bright),
            "\033[95m");
  ...
  EXPECT_EQ(Foxterm::get_color4(Foxterm::Color4_bg::magenta_bright),
            "\033[105m");
  ...
  EXPECT_EQ(Foxterm::get_color4(Foxterm::Color4_bg::yellow_bright),
            "\033[103m");
}
...
TEST(base_test, 8bit_conversion) {
  // foreground dark
  EXPECT_EQ(Foxterm::get_color8_fg(Foxterm::convert_bit24_bit8_dark(0, 0, 0)),
            "\033[38;5;16m");
  EXPECT_EQ(
      Foxterm::get_color8_fg(Foxterm::convert_bit24_bit8_dark(255, 255, 255)),
      "\033[38;5;231m");
  EXPECT_EQ(Foxterm::get_color8_fg(Foxterm::convert_bit24_bit8_dark(0, 255, 0)),
            "\033[38;5;46m");
  // background dark
  EXPECT_EQ(Foxterm::get_color8_bg(Foxterm::convert_bit24_bit8_dark(0, 0, 0)),
            "\033[48;5;16m");
  EXPECT_EQ(
      Foxterm::get_color8_bg(Foxterm::convert_bit24_bit8_dark(255, 255, 255)),
      "\033[48;5;231m");
  EXPECT_EQ(Foxterm::get_color8_bg(Foxterm::convert_bit24_bit8_dark(0, 255, 0)),
            "\033[48;5;46m");
  // foreground bright
  EXPECT_EQ(Foxterm::get_color8_fg(Foxterm::convert_bit24_bit8_bright(0, 0, 0)),
            "\033[38;5;16m");
  EXPECT_EQ(
      Foxterm::get_color8_fg(Foxterm::convert_bit24_bit8_bright(255, 255, 255)),
      "\033[38;5;231m");
  EXPECT_EQ(
      Foxterm::get_color8_fg(Foxterm::convert_bit24_bit8_bright(0, 255, 0)),
      "\033[38;5;46m");
  // background dark
  EXPECT_EQ(Foxterm::get_color8_bg(Foxterm::convert_bit24_bit8_bright(0, 0, 0)),
            "\033[48;5;16m");
  EXPECT_EQ(
      Foxterm::get_color8_bg(Foxterm::convert_bit24_bit8_bright(255, 255, 255)),
      "\033[48;5;231m");
  EXPECT_EQ(
      Foxterm::get_color8_bg(Foxterm::convert_bit24_bit8_bright(0, 255, 0)),
      "\033[48;5;46m");
}
TEST(base_test, 8bit_conversion_struct) {
  // foreground dark
  EXPECT_EQ(Foxterm::get_color8_fg(
                convert_bit24_bit8_dark(Foxterm::make_rgb(0, 0, 0))),
            "\033[38;5;16m");
  EXPECT_EQ(Foxterm::get_color8_fg(
                convert_bit24_bit8_dark(Foxterm::make_rgb(255, 255, 255))),
            "\033[38;5;231m");
  EXPECT_EQ(Foxterm::get_color8_fg(
                convert_bit24_bit8_dark(Foxterm::make_rgb(0, 255, 0))),
            "\033[38;5;46m");
  // background dark
  EXPECT_EQ(Foxterm::get_color8_bg(
                convert_bit24_bit8_dark(Foxterm::make_rgb(0, 0, 0))),
            "\033[48;5;16m");
  EXPECT_EQ(Foxterm::get_color8_bg(
                convert_bit24_bit8_dark(Foxterm::make_rgb(255, 255, 255))),
  ...
  // foreground bright
  EXPECT_EQ(Foxterm::get_color8_fg(
                convert_bit24_bit8_bright(Foxterm::make_rgb(0, 0, 0))),
            "\033[38;5;16m");
  EXPECT_EQ(Foxterm::get_color8_fg(
                convert_bit24_bit8_bright(Foxterm::make_rgb(255, 255, 255))),
            "\033[38;5;231m");
  EXPECT_EQ(Foxterm::get_color8_fg(
                convert_bit24_bit8_bright(Foxterm::make_rgb(0, 255, 0))),
            "\033[38;5;46m");
  // background dark
  EXPECT_EQ(Foxterm::get_color8_bg(
                convert_bit24_bit8_bright(Foxterm::make_rgb(0, 0, 0))),
...
TEST(base_test, 24bit_colors) {
  ...
  EXPECT_EQ(Foxterm::get_color24_underline(255, 255, 255),
...
TEST(base_test, 24bit_colors_struct) {
  // foreground
  EXPECT_EQ(Foxterm::get_color24_fg(Foxterm::make_rgb(0, 0, 0)),
            "\033[38;2;0;0;0m");
  EXPECT_EQ(Foxterm::get_color24_fg(Foxterm::make_rgb(255, 255, 255)),
            "\033[38;2;255;255;255m");
  EXPECT_EQ(Foxterm::get_color24_fg(Foxterm::make_rgb(20, 20, 20)),
            "\033[38;2;20;20;20m");
  EXPECT_EQ(Foxterm::get_color24_fg(Foxterm::make_rgb(3, 4, 5)),
            "\033[38;2;3;4;5m");
  // background
  EXPECT_EQ(Foxterm::get_color24_bg(Foxterm::make_rgb(0, 0, 0)),
            "\033[48;2;0;0;0m");
  EXPECT_EQ(Foxterm::get_color24_bg(Foxterm::make_rgb(255, 255, 255)),
            "\033[48;2;255;255;255m");
  EXPECT_EQ(Foxterm::get_color24_bg(Foxterm::make_rgb(20, 20, 20)),
            "\033[48;2;20;20;20m");
  EXPECT_EQ(Foxterm::get_color24_bg(Foxterm::make_rgb(3, 4, 5)),
            "\033[48;2;3;4;5m");
  // underline
  EXPECT_EQ(Foxterm::get_color24_underline(Foxterm::make_rgb(0, 0, 0)),
            "\033[58;2;0;0;0m");
  EXPECT_EQ(Foxterm::get_color24_underline(Foxterm::make_rgb(255, 255, 255)),
            "\033[58;2;255;255;255m");
  EXPECT_EQ(Foxterm::get_color24_underline(Foxterm::make_rgb(20, 20, 20)),
            "\033[58;2;20;20;20m");
  EXPECT_EQ(Foxterm::get_color24_underline(Foxterm::make_rgb(3, 4, 5)),
            "\033[58;2;3;4;5m");
}
TEST(base_test, reset) { EXPECT_STREQ(Foxterm::reset(), "\033[m"); }
...
TEST(base_test, hex_to_rgb_conversion) {
  ...
  EXPECT_EQ(Foxterm::convert_hex_rgb("FFFFFF").r,
            Foxterm::make_rgb(255, 255, 255).r);
  EXPECT_EQ(Foxterm::convert_hex_rgb("FFFFFF").g,
            Foxterm::make_rgb(255, 255, 255).g);
  EXPECT_EQ(Foxterm::convert_hex_rgb("FFFFFF").b,
            Foxterm::make_rgb(255, 255, 255).b);

  EXPECT_EQ(Foxterm::convert_hex_rgb("F0AB36").r,
            Foxterm::make_rgb(15, 131, 27).r);
  EXPECT_EQ(Foxterm::convert_hex_rgb("F0AB36").g,
            Foxterm::make_rgb(15, 131, 27).g);
  EXPECT_EQ(Foxterm::convert_hex_rgb("F0AB36").b,
            Foxterm::make_rgb(15, 131, 27).b);

  EXPECT_EQ(Foxterm::convert_hex_rgb("0F21CE").r,
            Foxterm::make_rgb(15, 5, 194).r);
  EXPECT_EQ(Foxterm::convert_hex_rgb("0F21CE").g,
            Foxterm::make_rgb(15, 5, 194).g);
  EXPECT_EQ(Foxterm::convert_hex_rgb("0F21CE").b,
            Foxterm::make_rgb(15, 5, 194).b);

  EXPECT_EQ(Foxterm::convert_hex_rgb("ABCDEF").r,
            Foxterm::make_rgb(131, 181, 239).r);
  EXPECT_EQ(Foxterm::convert_hex_rgb("ABCDEF").g,
            Foxterm::make_rgb(131, 181, 239).g);
  EXPECT_EQ(Foxterm::convert_hex_rgb("ABCDEF").b,
            Foxterm::make_rgb(131, 181, 239).b);

  EXPECT_EQ(Foxterm::convert_hex_rgb("123456").r,
            Foxterm::make_rgb(5, 19, 41).r);
  EXPECT_EQ(Foxterm::convert_hex_rgb("123456").g,
            Foxterm::make_rgb(5, 19, 41).g);
  EXPECT_EQ(Foxterm::convert_hex_rgb("123456").b,
            Foxterm::make_rgb(5, 19, 41).b);

  EXPECT_EQ(Foxterm::convert_hex_rgb("E62169").r,
            Foxterm::make_rgb(104, 5, 69).r);
  EXPECT_EQ(Foxterm::convert_hex_rgb("E62169").g,
            Foxterm::make_rgb(104, 5, 69).g);
  EXPECT_EQ(Foxterm::convert_hex_rgb("E62169").b,
            Foxterm::make_rgb(104, 5, 69).b);
